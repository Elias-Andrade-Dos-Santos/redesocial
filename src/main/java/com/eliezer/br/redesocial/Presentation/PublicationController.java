...
public class PublicationController {
    ...
    @PostMapping
    public ResponseEntity<Object> postMethodCreate(@RequestBody PublicationDTO data) { 
        return publicationService.createPublication(data);
    }

    @GetMapping("/{id}")
    public ResponseEntity<Object> getMethodGet(@PathVariable UUID id) {
